...
aggr_plot <- aggr(repayment, col = c('navyblue','red'), numbers = TRUE, 
                  sortVars = TRUE, labels = names(repayment), cex.axis = .7, 
...
# Results
summary(tree.repayment.oneyear) 
par(mfrow = c(1,1))
...
summary(tree.repayment.threeyear) 
par(mfrow = c(1,1))
